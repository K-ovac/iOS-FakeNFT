...
extension UIColor {
    ...
    static func dynamicColor(lightHex: String, darkHex: String) -> UIColor {
        dynamicColor(light: UIColor(hexString: lightHex), dark: UIColor(hexString: darkHex))
    }
    ...
    static let textCurrencyName = UIColor(hexString: "#1C9F00")
    ...
    static let Button = dynamicColor(
        light: yaBlackLight,
        dark: yaBlackDark
    )

    static let bottomContainer = dynamicColor(
        light: yaLightGrayLight,
        dark: yaLightGrayDark
    )

    static let emptyStar = dynamicColor(
        light: lightEmptyStarColor,
        dark: darkEmptyStarColor
    )
}